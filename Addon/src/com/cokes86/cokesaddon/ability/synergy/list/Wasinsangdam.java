...
public class Wasinsangdam extends CokesSynergy implements ActiveHandler {
    ...
    private static final Config<Integer> COOLDOWN = Config.cooldown(Wasinsangdam.class, "cooldown", 50);
    ...
    public void onCEntityDamage(CEntityDamageEvent e) {
        if (e.getDamager() != null) {
            ...
            if (resentment != null && damager.equals(resentment.getPlayer()) && e.getEntity().equals(getPlayer())) {
