...
public class Fish extends CokesAbility implements ActiveHandler {
	private static final Config<Integer> SPRINKLE_COOLDOWN = Config.of(Fish.class, "sprinkle-cooldown", 30, FunctionalInterfaces.positive(), FunctionalInterfaces.COOLDOWN);
	private static final Config<Integer> QUEAK_MAX_DRATION = Config.of(Fish.class, "queak-max-duration", 20, FunctionalInterfaces.positive(), FunctionalInterfaces.TIME);
	private static final Config<Integer> QUEAK_COOLDOWN = Config.of(Fish.class, "queak-cooldown", 60, FunctionalInterfaces.positive(), FunctionalInterfaces.COOLDOWN);
