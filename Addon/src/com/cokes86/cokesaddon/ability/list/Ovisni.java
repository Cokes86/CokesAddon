...
public class Ovisni extends CokesAbility implements ActiveHandler {
	...
	public static final Config<Integer> MAX_COUNTER_CONFIG = Config.of(Ovisni.class, "최대카운터", 15, FunctionalInterfaces.positive());
	public static final Config<Integer> DELAY = Config.of(Ovisni.class, "지속딜레이", 5, FunctionalInterfaces.positive(), FunctionalInterfaces.TIME);
	public static final Config<Integer> MAX_DAMAGE_HIT = Config.of(Ovisni.class, "최대_맹독_타격_횟수", 15, FunctionalInterfaces.positive());
