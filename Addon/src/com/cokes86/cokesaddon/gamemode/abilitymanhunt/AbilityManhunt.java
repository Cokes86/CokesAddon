...
@GameManifest(name = "능력자 맨헌트", description = {
        "한 명의 스피드러너와 헌터들!",
...
public class AbilityManhunt extends AbstractGame implements AbilitySelect.Handler, Winnable {

    public AbilityManhunt() throws IllegalArgumentException {
    ...
    protected ParticipantStrategy newParticipantStrategy(Collection<Player> arg0) {
        return new AMParticipantStrategy(this, arg0);
    }
