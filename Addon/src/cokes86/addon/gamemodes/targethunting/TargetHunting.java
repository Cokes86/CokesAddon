...
public class TargetHunting extends Game implements Winnable, DeathManager.Handler, DefaultKitHandler, AbstractGame.Observer {
    ...
    private int phase = 0;
    private final int inv = GameConfiguration.Config.getInt(GameNodes.TargetHunting_inv), game = GameConfiguration.Config.getInt(GameNodes.TargetHunting_gameTime);
    ...
    GameTimer phase2 = new GameTimer(TaskType.REVERSE, game) {
        Bar bar;
        
        protected void onStart() {
            bar = new Bar("", BarColor.GREEN, BarStyle.SEGMENTED_20);
        }
        @Override
