		...
		switch (i) {
			...
			case 15:
				...
				if (isRestricted()) {
					...
					wb.setCenter(spawn);
					wb.setSize(GameConfiguration.Config.getInt(GameNodes.BATTLE_ABILITY_START_SIZE));
					wb.setSize(1, GameConfiguration.Config.getInt(GameNodes.BATTLE_ABILITY_TIME));
				}
