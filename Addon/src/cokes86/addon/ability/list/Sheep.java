...
public class Sheep extends CokesAbility {
    private static final Config<Double> DAMAGE = Config.of(Sheep.class, "damage", 150.0, PredicateUnit.positive(),
            "# 불, 용암, 마그마블럭으로 인해 받는 대미지 감소량",
            " # 기본값: 150.0 (%)");
    private static final Config<Double> DAMAGE_REDUCE = Config.of(Sheep.class, "damage_reduce", 15.0, PredicateUnit.between(0.0, 100.0, false),
            "# 이를 제외한 모든 대미지 감소량",
            " # 기본값: 15.0 (%)");

    private static final Config<Integer> RANGE = Config.of(Sheep.class, "range", 5, PredicateUnit.positive(),
            "# 시선이 변경될 플레이어 거리 최댓값",
            " # 기본값: 5 (블럭)");
