...
public class Reisen extends CokesAbility implements ActiveHandler {
    private static final Config<Integer> MADNESS_ENHANCE_PREDICATE = Config.of(Reisen.class, "광기를_다루는_자.강화_조건", 25, PredicateUnit.positive());
    private static final Config<Integer> MADNESS_ENHANCE_PERIOD_DECREASE = Config.of(Reisen.class, "광기를_다루는_자.강화_주기_감소치(%)", 50, PredicateUnit.between(0, 100, false));
    private static final Config<Integer> MADNESS_PERIOD = Config.of(Reisen.class, "광기를_다루는_자.주기", 20, Config.Condition.TIME);
    private static final Config<Integer> MADNESS_RANGE = Config.of(Reisen.class, "광기를_다루는_자.범위", 5, PredicateUnit.positive());

    private static final Config<Integer> MIND_SHAKER_ENHANCE_PREDICATE = Config.of(Reisen.class, "마인드_쉐이커.강화_조건", 50, PredicateUnit.positive());
    ...
    private static final Config<Integer> EYES_RANGE = Config.of(Reisen.class, "광기의_눈동자.범위", 10, PredicateUnit.positive());
    ...
    private static final Config<Integer> EYES_ENHANCE_PREDICATE = Config.of(Reisen.class, "광기의_눈동자.강화_조건", 35, PredicateUnit.positive());
    private static final Config<Integer> EYES_ENHANCE_COOLDOWN_DECREASE = Config.of(Reisen.class, "광기의_눈동자.강화_쿨타임_감소치(%)", 50, PredicateUnit.between(0, 100, false));
