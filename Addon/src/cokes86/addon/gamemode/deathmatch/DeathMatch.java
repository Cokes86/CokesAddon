package cokes86.addon.gamemode.deathmatch;
...
@GameManifest(name = "데스매치", description = {
        "§f가능한 빨리 모두를 많이 죽여라",
        "§f가장 먼저 30킬을 달성한 플레이어가 승리하는 단순한 게임",
        "§f능력은 죽을 때 마다 새로 바뀌니 안심하세요~!"
})
public class DeathMatch extends Game implements Winnable, DefaultKitHandler, AbstractGame.Observer {
    private static final Logger logger = Logger.getLogger(DeathMatch.class);

    public DeathMatch() throws IllegalArgumentException {
