...
public class v1_18_R2 implements DamageImpl{
    ...
    private EntityDamageSourceIndirect magic(Entity nmsEntity, EntityPlayer nmsDamager) {
        ...
        if (nmsDamager != null) {
            ...
            source = new EntityDamageSourceIndirect("magic", setItem(new EntityPotion(nmsEntity.s, nmsEntity.dc(), nmsEntity.de(), nmsEntity.di())), null){{
                y(); m(); o();
            }};
        }
        return source;
