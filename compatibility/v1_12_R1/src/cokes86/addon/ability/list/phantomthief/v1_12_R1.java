...
public class v1_12_R1 extends PhantomThief {
    ...
    private static final ItemStack NULL_ITEMSTACK = new ItemStack((net.minecraft.server.v1_12_R1.Item) null);
    ...
    public v1_12_R1(AbstractGame.Participant participant) {
        super(participant);
    }
