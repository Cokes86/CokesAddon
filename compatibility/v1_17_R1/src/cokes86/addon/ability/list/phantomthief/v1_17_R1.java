...
public class v1_17_R1 extends PhantomThief {
    ...
    public v1_17_R1(AbstractGame.Participant participant) {
        super(participant);
    }
    ...
    public void onPlayerQuit(PlayerQuitEvent e) {
        ...
        if (channelHandlers.containsKey(player.getUniqueId())) {
            player.getHandle().b.a.k.pipeline().remove(channelHandlers.get(player.getUniqueId()).getRight());
    ...
    public void hide() {
        ...
        craftPlayer.getHandle().getDataWatcher().set(new DataWatcherObject<>(12, DataWatcherRegistry.b), 0);
    ...
    public void injectPlayer(Player player) {
        ...
        player1.getHandle().b.a.k.pipeline().addBefore("packet_handler", hashCode() + ":" + player.getName(), handler);
    }
}
