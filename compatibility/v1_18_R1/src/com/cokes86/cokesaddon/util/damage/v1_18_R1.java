...
public class v1_18_R1 implements DamageImpl{
    ...
    private EntityDamageSourceIndirect magic(Entity nmsEntity, EntityPlayer nmsDamager) {
        ...
        if (nmsDamager != null) {
            source = new EntityDamageSourceIndirect("magic", setItem(new EntityPotion(nmsEntity.t, nmsDamager)), nmsDamager) {{
                y(); m(); o();
            }};
        } else {
            source = new EntityDamageSourceIndirect("magic", setItem(new EntityPotion(nmsEntity.t, nmsEntity.dc(), nmsEntity.de(), nmsEntity.di())), null){{
                y(); m(); o();
            }};
        }
        return source;
