...
public class v1_16_R1 implements DamageImpl{
    ...
    private EntityDamageSourceIndirect magic(net.minecraft.server.v1_16_R1.Entity nmsEntity, EntityPlayer nmsDamager) {
