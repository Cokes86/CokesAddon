package com.cokes86.cokesaddon.util.nms.v1_14_R1;
...
import daybreak.abilitywar.utils.base.minecraft.nms.v1_14_R1.network.EmptyNetworkHandler;
import daybreak.abilitywar.utils.base.minecraft.nms.v1_14_R1.network.EmptyNetworkManager;
...
public class DummyImpl extends EntityPlayer implements IDummy {
    ...
    public DummyImpl(final MinecraftServer server, final WorldServer world, final Location location, Player skin) {
        ...
        getDataWatcher().set(new DataWatcherObject<>(15, DataWatcherRegistry.a), SKIN_BIT_LAYER);
        new BukkitRunnable() {
            @Override
            public void run() {
